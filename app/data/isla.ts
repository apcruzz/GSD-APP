...
export const islands: Island[] = [
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/samoa/samoa2.png'),
    sections: {
        overview: {
            image: [
                { index: 19, source: require("../../assets/images/samoa/samoanfale.jpg") },
                { index: 24, source: require("../../assets/images/samoa/kap.jpg") },
                { index: 26, source: require("../../assets/images/samoa/cocomilk.jpg") },
                { index: 31, source: require("../../assets/images/samoa/falefono.jpg") },
                { index: 41, source: require("../../assets/images/samoa/ietonga.jpg") },
                { index: 44, source: require("../../assets/images/samoa/matai.jpg") },
                { index: 48, source: require("../../assets/images/samoa/samoanchiefs.jpg") },
                { index: 58, source: require("../../assets/images/samoa/kava.png") },
                { index: 65, source: require("../../assets/images/samoa/tatau.png") },
                // { index: 1, source: require("../../assets/images/samoa/moai1.png") },
                ],
            paragraphs: [
            "SAMOAN KNOWLEDGE",
            "SAMOA & AMERIKA SAMOA",
            ...
            "",
            "Samoa and American Samoa – one people spread across two countries – are located about 2,600 miles [4,180 km] southwest of Hawaii. The two major and other smaller islands of Samoa include 1,130 square miles [2,930 km²] of land while about 77 square miles [199 km²] make up the five volcanic islands and two atolls of American Samoa.",
            "",
            "**Factoid:** The Scottish author Robert Louis Stevenson, or Tusitala, who spent his final years in Samoa and is buried there, dubbed the Samoans the “happy people” because of their enjoyment of life and good spirited nature.",
            "",
            "“**TALOFA!**” is the greeting word in Samoa. Because Samoa is in the center of the Polynesian triangle, it is referred to as **“the Heart of Polynesia.” Geographically speaking, there are, in fact, two Samoas. **Samoa** is an independent country of about 1,130 square miles and includes the islands of Savai'i and Upolu. The other, __American Samoa__, is a territory of 77 square miles administered by the United States government and includes the eastern islands, primarily Tutuila. The population of Samoa is just under __200,000__ and American Samoa has just under __60,000__ people. Jacob Roggeveen, a Dutch Explorer, is credited with its discovery in 1722.",
            "",
            "Although Samoa is two separate countries, its people, language and culture are one. From 1900 until the First World War, Western Samoa was a German territory. After World War I, it became a trust territory administere for the United Nations by New Zealand. In 1962, Western Samoa became the first independent Polynesian nation.",
            "",
            "The constitution of American Samoa defines the basic governmental and legal organization. It provides for executive, legislative and judicial branches. The Governor and Lieutenant Governor head the executive branch and the bicameral legislature is popularly elected.",
            "",
            ...
            "",
            "Buildings in Samoa are usually rounded in shape with domed roofs. Posts are spaced evenly around each structure with large supporting beams in the center. The Samoans favor round shaped roofs not only for their beauty and symmetry, but also for practical purposes. The round shape allows the rain to quickly run off to the ground with out any obstructions. The dome shaped structure are also durable and up keep is minimal, but most importantly they keep the interior cool and breezy during hot, humid days. Samoa’s location near the equator means the weather is often hot and humid, which is why you will notice that none of the buildings have walls.",
            "",
            "The breeze comes in off the ocean and helps to cool the occupants. Woven coconut leaf blinds, called **pola**, are attached to the beams of the buildings which can be lowered during strong winds, storms, or when privacy is desired. Roofing materials come from the leaves of the sugar cane plant, some of which are grown here in our plantation. The leaves are bundled together and cleverly attached in rows, round and around, until the whole roof is covered. A first time thatch job will last 10-15 years without repairs – in the absence of excessively strong winds.",
            "",
            // ![Typical Samoan fale](local:samoanfale.jpg)

            "Image: Typical Samoan fale with pola lowered on the right to block wind or rain. Some pola in the raised position can also be seen on the right of the building where the men of the village have gathered to meet.",

            "TUNOA or UMU KUKA: Kitchen",
            "In Samoa the kitchen was the man’s domain because the preparation and cooking of food was considered a physically demanding job. The Samoan earth oven is a typical hot rock oven, which is laid out above the ground. The oven utilizes round river or lava rocks that conduct heat extremely well. Four logs are arranged in a square with rocks, and then a fire is built to heat the rocks. When the fire has heated the rocks and they are white with ash, charcoal debris is pushed aside and the food is placed on the heated rocks. Fire resistant leaves are used to protect the food so they are not burnt. The whole oven is then covered with banana leaves and other insulating materials. Hunting, climbing coconut trees, husking, cracking and milking the coconuts all required physical strength, and the young men of the family show their respect to their parents, grandparents, and women by performing these arduous tasks. The young men prepare the food, and serve their grandparents and parents first. Then the young children eat. Finally, the cooks eat. This service is part of the Samoan Way of Life, or Fa’a Samoa, in which respect is taught at a young age. Young men serve their parents and elders in the same way their future children will serve them when they start their own families.",
            "",

            // ![Kap](local:kap.jpg)

            "The coconut is one of the most important items in the life of Samoans and other Polynesians. From the various parts of the coconut tree materials for buildings, clothing, and food preparation are obtained. The first step that must be done to use the coconut is to climb the very high tree to get it. Here in the Samoan village, you will be able to see how skillful the young men are at climbing the coconut trees, obtaining the coconuts, husking them and extracting its inner flesh for cooking purposes.",

            "Once husked using a very sharp stick, the actual nut itself appears to have a face on one end. Each coconut appears to have two eyes, a nose, and a mouth. To crack open a coconut, a Samoan uses a heavy object or stone and hits the line that runs across the face. The clear liquid inside the coconut is the juice. Young coconuts that have not begun to produce much inner flesh contain more juice than ripe coconuts. The coconut juice obtained from the very young coconuts is a refreshing drink in Samoa.",
            "",

            // ![Coconut Milk Preparation](local:cocomilk.jpg)

            "How do the Samoans get coconut milk? Inside the coconut is the white meat that can be grated and squeezed through a strainer made from various wood fibers. The white liquid that falls from the grated coconut is coconut milk and is used in all types of Samoan cooking. Other Samoan staple foods grown in the family garden include sugarcane, bananas, taro, tapioca, sweet potato, breadfruit, and the ava plant. Meats include pork, chicken, fish, and shellfish of all kinds.",
            "",

            "## FALE NONOFO or FALE AFOLAU: Family Dwelling House",
            "The Fale Nonofo is the family dwelling house. __Tapa__ is used to partition areas for sleeping. __Fala__, or mats woven from the dried & softened leaves of the pandanus tree, are placed on the floor each night for sleeping on, and rolled up and placed in the rafters each morning. The Fale Nonofo also serves as the eating-place, where the food is served to the family, after being cooked at the tunoa. As you observe the inside of this building, notice the cultural craftsmanship achieved by skilled workers under the supervision of the master builder. The master builder is responsible not only for the physical details, but also for the artistry of the building. A building of this size usually takes about 6 -8 weeks to complete depending on the number of men working and their skill levels. This particular structure also serves as a workshop in which men carve and women do arts and crafts. You can try your hand at making fire by rubbing two sticks together as demonstrated by the young men of Samoa.",
            "",

            "## FALE TALIMALO: Guest House and FALE FONO: Meeting House (Same building; different purposes)",
            "__Fale Talimalo__ means “a house to receive guests.” Not only pre-arranged guests are welcome to stay here, but also a person or group passing by who needs a place to rest. When pre-arranged groups arrive, the family (immediate or extended or the village) will prepare leis, food and special decorations. A special welcome ceremony would be included if the guest is a high ranking chief. When unexpected guests arrive, the immediate family will quickly prepare food and water. Bedding is provided if the stay is extended. After the guests are fed and have rested, the chief will inquire as to the purpose of the unexpected visit and the intended length of stay. He will then offer any further assistance as needed.",
            "",
            "When not being used to host visitors, this building is also used as the __Fale Fono__, meaning, “meeting house.” As a __Fale Fono__, this building is to serve the chiefs of the village as a gathering place to discuss the affairs of the village. The discussions include monitoring the performance of individual families, the safety of all the villagers, each family beautifying their yards, planting food crops and raising meat animals to encourage self-reliance and generally maintaining order in the village.",
            "",
            // ![Falefono](local:falefono.jpg)

            "The posts surrounding the structure have special significance in Samoa. During meetings and ceremonies, participants sit with their backs to a post representing their rank, family, or home village. Some posts are reserved for various people of prestigious rank. The post centered at the left half of the entrance is for the highest-ranking person in the visiting party, usually a chief. The post immediately opposite is for the highest-ranking person of the home village, again usually a chief. The posts on either side of the main entrance post are for the chief’s spokesmen known as the talking chiefs. The next two posts on the left are for other local talking chiefs. Other minor participants sit on mats spread around the outside rim. An interesting custom in Samoa is the fourth post from the left, known as the stranger’s post. If a stranger comes into a meeting unannounced and demands it, the post must be surrendered to him. From the three posts in the middle any food to be served during the meeting is dispensed. The kava ceremony takes place in this building. Not only does it represent the highest form of welcome to guests, it also represents a unity of purpose. The significance lies in each chief drinking from the same coconut cup, representing a solemn commitment to ally himself with the consensus of the council. It is a sign of loyalty and symbolizes the highest ideals of all participants and the village people they represent.",
            "",
            ...
            "Fine mats, or __ie toga__, used for ceremonies in this building, require special weaving skills. The pandanus leaves are cleaned, boiled, and bleached in the sun until the desired shade of whiteness is reached. The leaves are then flattened and left to season for about a week. The weaver then takes a shell or possibly the sharp, hard wing of a coconut beetle and cuts the leaves into fine strands for weaving. Some of the mats are woven so fine that they have the appearance of expensive linen. After a mat is completed, it is given a name and used as the traditional currency of Samoa. Mats are given as gifts at weddings, funerals, the dedication of buildings, chiefly ceremonies, and other special occasions. It takes many years of work to make an exceptionally fine mat.",
            "",

            "## MAOTA O LE ALI’I or MAOTA TOFA: Chief’s House",
            "__Matai__ is the Samoan word for leader or chief. There are two types of matai in Samoa - the __Ali’i__ and the __Tulafale__. The Ali’i is the name of the highest title in a family. Those who hold an Ali’i title preside at council meetings, oversee proceedings, make the final important decisions (after consulting with other matai), and pass their instructions along in whispers to the High Talking Chiefs, or __Tulafale__, who are the mouthpieces of the Ali’i. They are expected to be eloquent and skilled in the art of __lauga__ (oration). The Tulafale represent the Ali’i as his spokesperson. The political system of Samoa was much more open than in any other Polynesian group in the Pacific. Rather than being solely hereditary, it is possible for people to rise to chiefly status by virtue of his or her abilities, loyalty to the village, and the service one provides to the families in the village. The title of chief is conferred upon any eligible member of the group, including women, with the common consent of the village and the chief’s council. The chiefs are responsible for the general welfare of the group.",
            "",

            // ![Matai](local:matai.jpg)

            "The __Maota Tofa__ is the Chief’s house. In Samoa, this building is usually elevated 5-8 feet signifying the Chief’s prestige. A building of this size sometimes takes 3–4 months to build depending on the manpower. The master builder, called the __Tufuga__, plans and instructs all workers of the measurements of each beam and pole. He determines the fashion and the design of the sennit lashings, which hold all joints in place. The way the beams are fastened together gives support to every 6--7 feet of the roof and strengthens the roof against the strong winds and heavy rain. The large beams and the poles are cut from the native trees of Samoa. The __ifilele__ (Iron wood), __koi__ (Mahogany), __niu__ (Coconut), __fau__ (Balsom). There are three main reasons why a chief would have a building as large and beautiful as this. **(1)** The chief is a well-respected individual by his family and the community and the building represents their support and goodwill. **(2)** His title is of a royal line, or it is the highest in the family, village or district, which he represents. **(3)** It represents the wealth of a strong family group or unified collection of villages. The chief’s house was simply furnished. Because finely woven mats were exchanged as currency, the more mats a chief possessed and displayed, the richer he was. They were important also as a method of paying tribute at weddings, funerals, and other public events.Only the chief would sleep on a bed, which is made of mats stacked to a desired height. Pillows were made of bamboo and actually supported the head at the back of the neck. Samoans believe that sleeping on a hard surface will give you a strong and straight posture.",
            "",
            ...
            "o __TANOA FAI AVA__ (ava bowl). The chiefs perform a ritual ceremony of the ava in which a special drink is mixed in this bowl. It symbolizes peace, brotherhood and unity.",
            "o __TAO__ (or spear). It represents each chief as a warrior and shows that he is prepared and ready to fight for his family, his freedom and his village.",
            "",
            ...
            "",
            "Tattooing is a painful process. The Samoan tattoo master creates the designs with a comb-like tattoo instrument. The larger the comb, the greater the area on the skin is covered with fewer strokes. He punctures the skin by tapping the instrument with a small mallet. Samoan women were also tattooed, but usually in lesser quantity.",
  ...
  },
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/nz/NZ.png'),
    sections: {
        overview: {
            image: [
                { index: 19, source: require("../../assets/images/samoa/samoanfale.jpg") },
            ...
            "Aotearoa, located about 4,606 miles [7,412 km] from Hawaii, forms the southwest apex of the Polynesian Triangle. The country covers approximately 103,000 square miles [268,000 km²] - about the size of Japan or the U.S. state of Colorado – and consists of two major islands as well as several smaller island groups. The four-season climate turns semi tropical in the north but includes high snow covered mountains in the south.",
            "",
            ...
            "Later, in the 10th century, Kupe & Ngake (Ngahue) ventured out southwest from Tahiti, following the traditional navigational instructions left by the hero Maui so many years earlier. The instructions were simple -- they were to keep their bearings towards a certain set of stars in the sky.",
            ...
            "They remained isolated in New Zealand until the arrival of European explorers, the first of whom was the Dutchman Abel Tasman (1642). During that time, they grew in numbers to between 100,000 and 200,000, living almost exclusively on North Island.",
            "They adopted the name Maori to distinguish themselves from the Europeans, who after the voyages of the Englishmen Captain James Cook (1769-1777), began to come in greater frequency. Individuals, families, and extended family groups continue to acknowledge one another and are identified as descendants of specific tribal and sub-tribal ancestral leaders.",
            "These tribal leaders can trace their genealogy to the original settlers who arrived in multiple waves of migration aboard ocean-voyaging canoes.",
            ...
            "",
            "PUHARA: Watchtower",
            "The watchtower or Puhara, was built to protect the village. Puhara were manned 24-hours per day. A village was usually situated on top of a hill so that the extra height of the tower could allow a man to see for miles on all sides. If strangers were approaching, the man in the watchtower would blow a large wooden trumpet called the pukaea to warn the people in the village. A scout would then be sent to ascertain whether the strangers came in peace or in war. Maori protocol calls for a ceremony-of-sorts to be performed in these cases called powhiri in which the intent of the visitors is determined. You can see the powhiri protocol demonstrated here in this village.",
            "",
            "PATAKA: Storage House",
            "The storage hut was used to house heirlooms such as his jade pendants, weapons, adzes for canoe building, etc.",
            "The Maori people ate fish, shellfish, birds, and small animals. They often salted, dried, or smoked various food items and placed them in gourds for storage. Sweet potatoes, tapioca, and the 'Maori Potato' were food staples.",
            "They also used roofed storage pits. These are partially underground with drainage on the sides of the house. They were not only used to store food, but also to store the plants which would be used next season.",
            "As with other Polynesians, the Maoris cooked in open-air cooking spaces, in underground ovens called a hangi. A pit was dug and logs were placed inside with rocks on top of the logs. As the logs burned, the rocks fell into the pit. The food was then placed on the hot rocks and covered with leaves or mats to keep the heat in for several hours, steaming the food.",
            "Other methods used were geothermal steaming, grilling food on sticks over embers, wrapping food in clay or leaves and placing them on the embers, boiling food by placing red-hot stones in wooden bowls of liquid.",
            "",
            "WHARE TUPUNA: Ancestral Meeting House",
            "The Whare Tupuna, or the Ancestral Meeting House, is typical of those found in Maori villages in New Zealand. Such buildings are very important to the Maori people because this is where customs and ceremonies are maintained and perpetuated. In 1960, this particular building was commissioned, carved in New Zealand under the direction of Master Carver Hone Taiapa and shipped to Hawaii piece by piece where it was then put together for use here at the Polynesian Cultural Center.",
            "This ancestral meeting house is named after Hawaikiroa, an ancient mariner who arrived in these islands (now known as Hawai’i) over 2,000 years ago, and according to legend, named them after himself.",
            "",
            "The architecture and design of the building is full of symbolism. It represents the physical anatomy of the human body of the ancestor for whom the building is named. The apex of this building has two figures, the lower one, holding a paddle is Hawaikiroa, the common ancestor. The figure at the very top, represents his son. The facing boards on the gable of the house represent his outstretched arms, hands and fingers extended and reaching towards the ground. The ridgepole of the house represents his spine or backbone and the painted rafters, his rib cage.",
            "Inside, the intricately carved figures on the walls represent the genealogy and family history of a tribe. Each figure or poupou depicts a specific ancestor and indicates information about him and his accomplishments. The eyes in the carvings were made from paua shell also known as abalone. The carvings depict tattooed faces, piercing eyes, protruding tongues and flexed leg muscles in dancing or fighting positions. These same traditional gestures are used today in dances performed in New Zealand and here at the Polynesian Cultural Center.",
            "A person’s status in the community was determined by his bloodline. Hence, it was crucial for the Maoris to memorize and recite their genealogies. These carved figures are constant reminders to the people of their ancestry. The stories, histories and genealogies of these ancestors continues to be preserved in the carvings, the oral history and music of the people. The present generation continue to bear their names.",
            "Painted scroll ornamentations on the rafters are more than just decorative. They’re called kowhaiwhai (circles within circles). They represent various foods and plants such as the sweet potato, peas, berries, and curling fern and are symbolic of nature and its importance. They tell stories of local history, symbolize aspects of the natural world and represent genealogies.",
            "Between the carvings are the tukutuku panels that are woven by Maori women. Each design depicts a particular tribal historical legend that is passed from generation to generation through the weaving of these panels. The set of six panels on a stand at the end of the room tells the story of the original Maori migration to New Zealand. They are woven from the dried leaves of the kiekie vine, which is found abundantly throughout New Zealand. The yellow and white colors are the natural shades after drying has taken place.",
            "",
            "KIA NGAWARI:",
            "Kia Ngāwari houses examples of the art of Māori weaving. Weaving techniques, include finger-weaving (related to twining), ornamental lattice work, patterned strand work, braiding, weft twining and plaiting.",
            "One of the more important varieties of native plant species found in Aotearoa New Zealand is the flax plant. The leaves can be used to craft mats, hats, bags, baskets, and even sails. The exposed inner fibers can be dyed and braided or woven into rope, fishing nets and the flax-made kilts used in the performing arts. Without the use of looms, weavers use the fibers to weave cloth, very similar to linen, which can be used as a wrap-around cloak. Many cloaks today are beautifully adorned with feathers.",
            "",
            "KUPE:",
            ...
            "· Case #2 - Stone: Examples of Nephrite Jade, Argillite, Garnet (used as a hammer stone), Obsidian and Sandstone.",
            "· Case #3 - Bone / Teeth / Shell: Examples of 8 shark species (found in Aotearoa New Zealand waters), abalone and whalebone.",
            "· Case #4 - Traditional Facial Markings: Examples of a bone chisel, mallet, ink bowl, tree resin, carved mask and portraits of male and female aristocracy. This practice became outlawed in 1907.",
            "· Case #5 - Dye: Examples of flax fibers, mordant (substance used to set dye on fibers and fabric) was made from the leaves of forest trees and shrubs, including the Celery Pine and Tea tree; forest tree bark; and iron-rich mud.",
            "· Photos on display include Hone Taiapa, MBE, the Master Carver; Matthew Cowley, the visionary of the PCC; numerous previous employees of the marae (now deceased) and the Te Arohanui Māori Company performers.",
            "",
            "WAKA TAUA: War Canoe",
            "This Waka Taua or war canoe of New Zealand is one of the greatest examples of Maori carving. The canoe was named the ‘Long Fish of Māui’ (see Māui’s Legend above). Traditionally, a war canoe was used as a raiding vessel along the coastlines, inland lakes and rivers. Fully manned, it could reach a speed of up to 15 miles per hour (13 knots) for short distances. In some canoes, sails were also rigged to add to the speed.",
            "",
            "HISTORY OF THE WAKA TAUA (WAR CANOE): TE IKA-ROA-A-MĀUI - The Long Fish of Māui",
            "On the 6th of March 1948, it was announced that King George VI (r 1936-1952) and Queen Elizabeth would embark on a Royal Tour of Australia and New Zealand the following Spring of 1949, accompanied by their daughter Princess Margaret. They would be the first reigning monarchs to visit both countries. (National Portrait Gallery, London - 1951)",
            "As part of the many preparations that took place for this tour to New Zealand, a giant Kauri (Agathis Australis) tree from the Puketi State Forest, Northland was felled in October of 1948. A Waka Taua (War Canoe) was to be crafted from this tree and used as part of the welcome ceremony for the Royal Family by the Ngāpuhi people. In addition, the canoe was to be presented as a gift to His Royal Highness.",
            "On the 23rd of November 1948, the tour was cancelled due to the King’s declining health. However, the work of construction carried on until the hull of the canoe was sufficiently completed to be transported out of the bush. The canoe was brought to rest near the Kohewhata Marae Hall, Mangakahia Rd, Kaikohe.",
            "The idea to complete the canoe resurfaced in the early 1960’s due to the Polynesian Village’s Project, which was already underway in Lā’ie, Hawai’i and Tuhikaramea, Aotearoa, NZ. Members of the Witehira, Wihongi and Tahere families are pictured here donating the hull of the canoe to the Polynesian Villages Building Committee Supervisor, John Elkington, Sr. (front left) in late 1962.",
            "",
            "TOHUNGA WHAKAIRO (MASTER CARVERS)",
            "Hone (John) Te Kauru Taiapa, MBE Wiremu Piri (Bill) Te Ranga Poutapu, MBE (1912-1979) (1905-1975) (Ngāti-Porou) (Ngāti-Korokī)",
            "Hone Taiapa was the Master Carver of the meeting house in Hawai’i, Hawaikiroa. He called on Piri Poutapu, also a Master Carver, to oversee the completion of the canoe. Two other experienced carvers joined the team to complete the canoe under his direction.",
            "Tuti (Tony) Tukaokao (1929-2001) (Ngāti-Ranginui) carved the taurapa (stern post) and a majority of the rauawa (side boards).",
            "James Te Kori (Jim) Ruru (1927-1966) (Te Aitanga-a-Māhaki) carved the tauihu (prow-piece).",
            "Hēmi Whautere Witehira (1881-1965) accompanied the canoe on its’ journey to Hawai’i in August of 1963. He is pictured here with Te Ika-roa-a-Māui canoe next to the lagoon at the Polynesian Villages which became known as the Polynesian Cultural Center.",
            "Te Ika-roa-a-Māui canoe (above) resting near the marae (courtyard) with women performing the poi and men posing next to it (below).",
            "Te Ika-roa-a-Māui canoe on the lagoon with performers twirling the poi. Te Ika-roa-a Māui war canoe at rest next to the marae (courtyard) and on the lagoon.",
            "",
            "TREE SPECIES:",
            "KAURI",
            "Agathis australis, commonly known by its Māori name Kauri, is a coniferous tree of the Araucariaceae in the genus of Agathis. Kauri trees can grow to over 50 metres (160+ feet) tall and up to 7 metres (23 feet) in diameter.",
            "TŌTARA",
            "Podocarpus totara (tōtara) is a species of podocarp tree. Tōtara trees can grow up to 40 metres (130 feet) tall and over 6 metres (16 feet) in diameter.",
            "Te Ika-roa-ā-Māui is 18.2 metres (60 feet) and weighs close to 2500 kgs or 2 ½ tons. This canoe carries between 34 - 40 people inclusive of the paddlers, the steersman, the leader, and a bailer.",
            "",
            "MAORI WARRIORS:",
            "This is a Taiaha. The Taiaha served as a broadsword quarterstaff, club, and spear. It is a fire-hardened wooden stave that had a long tapered, flattened shaft or blade, which broadens towards the end and has a head, nose, eyes, lips, teeth, and mouth, with a tongue-shaped spearhead on the opposite end.",
            "The ancient Maori chiefs at ceremonial gatherings also used the taihaha. The Maori orator when making a speech emphasized his words with gestures and taiaha actions called taki.",
            "The taiaha and greenstone mere (flat club) were both perfect weapons for close quarters combat. The advantage of a shorter club like the mere is its portability. It was usually tucked into the back waistband of the warrior’s skirt and hidden from sight behind a cloak. Weapons were often named after an ancestor.",
            "",
            "ACTIVITIES:",
            "Tītī-tōrea",
            "Traditionally, this game was one of many military games played in childhood. The objective of the game was to develop and maintain effective eye-hand coordination skills, essential in future hand-to-hand combat. The game still teaches those same skills today.",
            "It requires players to simultaneously toss sticks back and forth to each other in various patterns and in rhythm to music or chant. Players try to catch the sticks without dropping any of them and to have fun.",
            "",
            "Long-Poi",
            "Poi is a light ball on a string of various lengths, swung or twirled rhythmically and in unison to sung accompaniment. Traditional poi can be made from bullrush (cat’s tail leaves) and attached to a flax cord or rope. Modern-day poi can be made with foam and plastic, while the handle can be plaited from yarn or cord.",
            "Poi can be struck with either side of the hand and shoulder to create a percussive rhythm, imitate the sounds, movements and rhythms of nature. Matched with song, it can be used to enhance storytelling.",
  ...
  },
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/fiji/fiji2.png'),
    sections: {
        overview: {
            image: [],
            paragraphs: [
            ...
            "Fiji straddles the International Date Line about 3,100 miles [5,100 km] southwest of Hawaii.",
            "The independent tropical nation covers approximately 7,050 square miles [18,270 km²] – slightly smaller than the U.S. state of New Jersey – and includes two major islands plus about 330 smaller ones, and more than 500 islets (tiny rock formations in the ocean that are unable to sustain human habitation). The two main islands, Viti Levu & Vanua Levu, are rich in resources, including gold and copper mines.",
            "Factoid: The Fijians were historically known as fierce warriors until soon after the paramount chief converted to Christianity in 1854.",
            "",
            "FIJI",
            ...
            "This structure (see photo below) is a typical bure or house. Because Fiji consists of many islands over a wide area, house structures differ from location to location. The structures found here at the Polynesian Cultural Center are patterned after structures found in the Lau group of the islands of Fiji.",
            ...
            "Lali or drums were used for long distance communication. Through various rhythms a message could be sent. Today a lali is used much like a bell to call people to meetings or in time of emergency. In ancient times the lali was used during funerals and was beaten continuously, night and day, until the funeral ended. Smaller lali are used to accompany singing and dancing. Another form of communication favored by the Fijian people is the conch shell. After a hole is cut in the side of the shell, it is played much like a horn. Fishermen would blow it when returning to the village, indicating a good catch.",
            "",
            ...
            "The fibers of the husk are braided to make sennit cord used to lash all buildings together. A common use of husk fibers is as a scrubber for kitchen utensils and the body. The Fijians also hollowed out the coconut shells for drinking cups, soap dishes, water bottles and containers plus a myriad of other uses. When charcoal is needed, they burn coconut shells. Coconut milk is put in an airtight container to which flower petals and fragrant leaves are added. The container is left in the sun for several days. New petals and leaves are added daily until the coconut oil is clarified and ready to use as moisturizing lotion or soap.",
            "",
            "CAMAKAU: Fijian Canoe",
            "Canoes played an important role in the lives of the Fijians; they were used for social purposes, economic reasons (trade) and for the most part political purposes. In times of war, canoes such as this were used in sea battles for ramming enemy canoes as well as transporting warriors to sites of land battle. Superior canoes conferred political advantage to an island, which resulted in both protection, and the ability to conquer other islands.",
            ...
            "",
            "FIJIAN WEAPONS:",
            "A little over a hundred years ago, the Fijians were using many types of clubs. Apart from the gadi, a small ornamental club carried by correctly dressed warriors and chiefs at peacetime ceremonial occasions, all clubs were used for war. They were therefore made of the hardest woods, such as ironwood or vesi. Many had fine linear carving on their handles, designed by the individual warrior who made and used the club.",
            "The Iula were throwing clubs with short handles and bulbous heads. These were the most deadly Fijian clubs capable of competing with revolvers in close situations. If the handle struck the victim first it could penetrate the flesh, the heavy head jack-knifing onto the victim even if the handle did not pierce him, thus dealing a crippling, if not finishing blow.",
            "The cai or qata, the spurred or 'gun stock' clubs (so-called because of their resemblance in appearance to rifle butts or stocks), are designed for cutting and disjointing blows. That of a rifle did not inspire their shape although they look similar to one, but rather by the shape of the 'bird of paradise' flower.",
            "The waka or the root club had straight handles with a natural knot of roots at the end and were used to crush skulls easily.",
  ...
  },
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/hawaii/hawaii1.png'),
    sections: {
        overview: {
            image: [],
            paragraphs: [
            ...
            "Hawai’i, at the northern apex of the Polynesian Triangle and the only major part of Polynesia above the equator, is located approximately 2,500 miles [4,000 km] west south west of the US Mainland. Eight major islands (seven inhabited) and over 100 smaller ones cover approximately 6,400 square miles [16,600 km².] The climate ranges from tropical rainforests to high volcanic peaks covered in winter snow.",
            ...
            "The Hawaiian greeting of ALOHA is probably the most well known Polynesian word. Of the more than twenty islands in the Hawaiian group, only seven are inhabited. Hawaii spreads over a distance of about 400 miles. The eight main islands (seven of which are inhabited) are volcanic islands while the others are small coral islands. Together, they comprise about 6,424 square miles of land. The population of approximately 1.3 million (80% of which live on Oahu) is composed of a mixture of Polynesians, Asians, and Caucasians.",
            ...
            "After an initial discovery by the Spaniard Gaetano, the Hawaiian Islands were rediscovered by Captain James Cook in 1778. Captain Cook named the discovery the “Sandwich Islands” after his patron, the Earl of Sandwich.",
            ...
            "Each mokupuni was divided into several moku, the largest units within each island, usually wedge-shaped and running from the mountain crest to shore. O`ahu was divided into six moku. Each moku was divided into ahupua`a, narrower wedge-shaped land sections that again ran from the mountains to the sea. The size of the ahupua`a depended on the resources of the area with poorer agricultural regions split into larger ahupua`a to compensate for the relative lack of natural abundance.",
            ...
            "In ancient Hawaii their religious beliefs and practices did not permit the family the opportunity to eat together. The women of the family had their own eating-house called Hale ‘Aina. All children would eat with their mother in the women’s eating-house until the young boy turned 8, 9 or 10. The age varied in different areas. At that time he would move to the Hale Mua and learn the ways of men.",
            "The Hale Mua was the socio-cultural institution for religious services, political matters concerning the community, and perpetuation of traditional cultural practices and beliefs. This included customary rituals associated with boys growing into productive, contributing men in society. It implies teaching gender roles and responsibilities, customs, life skills, proper behavior and conduct, and guidance and support of spiritual growth. It’s where Hawaiian men earned the roles and responsibilities of being a successful father, husband, and warrior, and basic occupations like farming and fishing. Elders and master practioners served as educators. This emphasized moral character development and adherence to kapu governing forbidden or inappropriate behavior. The education received in the Hale Mua also encouraged the preservation and maintenance of mana or power. By sustaining one’s mana each man fulfilled his kuleana or responsibilities by honoring his kupuna or elders.",
            "This type of societal rule called kapu, also prevented women from eating certain foods like bananas, coconuts and specific types of fish. It was followed until the year after Kamehameha’s death, when Liholiho (Kamehameha II) ate together with his mother, Ka’ahumanu, abolishing the kapu.",
            "The la’amia (or calabash) is an evergreen tree that grows to around 25 ft in height that produces large, thin-shelled waxy, green, spherical gourd, up to 20 inches in diameter. This gourd is called ipu and is dried out, hollowed and used as a bowl. La’i or ti leaves are used like tin foil wrapping when doing barbeques. They store the cooked food in the leaf or wrap the raw foods in the leaf and cook it. Various woods were used as bowls and trays.",
            "In the corner of the building there are ki’i or handcarved wooden images representing Hawaiian dieties.",
            ...
            "This building was used by the fishermen to store items such as fish net, crab nets, weights, cordage, and bamboo needed for making nets and other such items used by fishermen. It was usually located close to the seashore, where fishermen could mend their nets and access their fishing gear. Nets and lines like this were made of olona vines or coconut husk fibers and were valued possessions. Fish hooks were made out of tortoise and oyster shells, and pig, dog, or even human bones. Certain hardwoods or lava rock was used to shape the hooks.",
            "",
            ...
            "Hula ‘auana, or modern-style hula, arose from adaptation of traditional hula ideas (dance and mele) to Western influences. The primary influences were Christian morality and melodic harmony. Hula ‘auana still tells or comments on a story, but the stories may include events since the 1800s and are more of an entertaining nature. The music is heavily Western-influenced, and usually includes the accompaniment of less traditional instruments, like the guitar, steel guitar and ukulele.",
            "There are two songs that are sung as guests learn the hula ‘auana in the Hawaiian village: I Don’t Like Shoes I don’t like shoes upon my feet To be at ease is such a treat and I smile at everyone I meet; That’s the Hawaiian in me. Along the Beach Along the beach at Waikiki A fair wahine is waiting for me, With nice eyes and lovable charms And a sweet Hawaiian hospitality.",
            "",
  ...
  },
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/tahiti/tahiti1.png'),
    sections: {
        overview: {
            image: [],
            paragraphs: [
            ...
            "The island of Tahiti, administrative center of French Polynesia, often represents all of the 116 surrounding tropical high rise islands and atolls in the Society Islands, Austral Islands, Tuamotus, Gambier and Marquesas Islands. Tahiti is located approximately 2,700 miles [4,350 km] southeast of Hawaii or about half-way between South America and Australia. The combined land mass covers about 1,400 square miles [13,660 km²].",
            "Factoid: Tahitian craftsmen sometimes bury newly carved wooden drumsticks in mud for several years before using them to assure just the right degree of hardness and proper tuning.",
            "",
            "TAHITI",
            ...
            "Tahitian fish traps were not actually used to trap fish but to store them. The fish were caught first whether by a’ira (line) or upe’a (net) and then placed inside the bamboo trap or ha’ape’e. The door was then closed and the whole trap placed in the water and kept halfway afloat using floats attached on either side. Floats were carved out of burau (balsa) or wild hibiscus wood. Thus the fish are kept alive so whenever fresh fish is needed, they are readily available in the bamboo trap.",
            "Each night the fisherman brings all his nets, nape or taura (ropes), auri patia i’a (fishing spears), traps, and other equipment inside his shed for repair and safekeeping. The next morning, he is ready to start a new day of tai’a or fishing. From small sheds such as this, fishermen wait for the right time to go fishing, while contemplating the beauty of their islands, or chatting with a friend, or watching over their pearl crop.",
            "Diving for mother pearls, an ancient and high risk method practiced by the people of the Tuamotu to obtain, on rare occasions, a black pearl from a mother pearl, has quickly become a thing of the past since the introduction of black pearl farming by Japanese experts in the late 70's. With the aid of modern technology and a new method of farming the mother pearl, this dying source of industry was quickly revived as the black pearl business began to boom throughout the Tuamotu islands.",
            ...
            "These human like figures carved in basalt, volcanic tuff, or wood are usually found near a marae or other holy places. Experts believe tikis had religious significance and symbolized Gods and/or deceased ancestors. Well preserved Tikis are found throughout Polynesia, particularly in the Marquesas Islands, the largest being 9 feet tall.",
            "A fear of evil or bad luck coming to individuals who disturb tikis may influence some natives. More likely, the hope that tikis should be protected so future generations can view them, explains the respect for tiki’s shown by most islanders.",
            "Priest (Tahu’a)",
  ...
  },
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/tonga/tonga1.png'),
    sections: {
        overview: {
            image: [],
            paragraphs: [
            ...
            "The kingdom of Tonga – consisting of Ha’apai, Tongatapu and Vava’u island groups – is the about 3,100 [4,950 km] southwest of Hawaii, or about two thirds of the way to New Zealand. It is also east of Fiji and southwest of Samoa. The approximately 170 islands, most of which are low-lying and fertile, cover a landmass of about 280 square miles [710 km²].",
            "Factoid: The letter ‘g’ in Tongan is always pronounced like ‘ng’ as in the English word singer – even when it is the first letter in a word – and never as the word finger.",
            "",
            "TONGA",
            ...
            "MISSION HOME:",
            "The Missionary house is similar to a house in which early Christian missionaries lived. The first to actively introduce Christianity to Hawaii were the Congregationalists from New England in 1820. They came with their wives (they were required by their organization to be married). The head of the first group was Hiram Bingham and his wife Sybil, pictured on the wall. The Congregationalists developed a writing system for the Hawaiian language so they could translate the Bible into Hawaiian. Roman Catholic priests and nuns lived in much plainer structures. Some missionaries lived with the local Polynesians in their own homes rather than having separates homes. In this way, they were able to learn Polynesian languages and customs more quickly.",
            "When missionaries first arrived in the islands, they endeavored to maintain some of the lifestyle of their homeland. They continued wearing the same style of clothing and built the same types of structures. In order to accomplish this, they brought many things with them to the various island mission fields. They also imported many goods and learned to adopt and adapt many of the Polynesian ways. Thus, in the building and decorating of homes, schools, and chapels, there was a mixture of things brought from the missionaries’ homeland and things indigenous to Polynesia.",
            "Samples of imported goods are found in the podium and organ in the chapel and in the finer crafted furniture, windows, and doors in all the buildings. Calico for draperies, tablecloths, and quilts, and the sea chest used during the journey to the mission were also imported items.",
            "The mission home features a curtained canopy bed covered with a wedding ring quilt the family brought over from their New England home. The wooden chest carried belongings on their journey and the desk was stored with writing materials to send letters to their loved ones. The dining room is set with the family’s special china, Blue Danube.",
            "Missionary wives taught Hawaiian women the art of quilting. Originally the missionary wives taught the Hawaiian women how to do patch quilting back in 1820 when they first came. The Hawaiian women really enjoyed quilting and by 1850 had developed their own style. Hawaiian quilts usually represent flowers and plants though there are some that represent cultural or historical themes. These designs are cut symmetrically and are always appliqué. Traditionally there are only two solid colors in the quilt. A king-size Hawaiian quilt takes about 9 months, working 40 hours a week to make. A small block quilts take about 35 – 45 hours to complete. There are quilt kits available in the Mission Home for those who would like to try their hand at Hawaiian quilting.",
            "",
            "SCHOOL HOUSE",
            "This is what schools looked like in Hawaii during the 1850s. The floors though were sand or dirt and the students would sit on mats and write on slates. The Congregational missionaries started these schools so that people could learn to read and write in Hawaiian and thus be able to read the Bible. Before these missionaries developed a written form of Hawaiian, important information such as genealogy and history were memorized in the form of chants. Designated people would learn these chants and then pass them on. It was a very accurate system. When the missionaries developed the writing system everyone was invited to learn it so these schools were not just for children but for anyone who wanted to learn to read and write.",
            "The Hawaiian alphabet consists of 5 vowels and 7 consonants. The vowels are a (as in award), e (as in elephant), i (as in eagle), o (as in oh, u. In Hawaiian our vowels are consistent. There are no silent sounds and there is always a vowel in between any two consonants. The consonants are pronounced like English consonants. The “w” is pronounced like a “w” or a “v” depending what comes before it. Usually, if it is at the beginning of a word it is pronounced like a “w” and if it is in the middle of a word it has a “v” sound.",
            "We have two additional marks that are used. This mark that looks like an apostrophe is called an ‘okina. What it does is break up the sounds of the vowels. If one of these marks is between two vowels, the vowels are pronounced separately. For example, La’ie. This other mark is called a kahako and what it does is extend the sound of the vowel as in the word lū’au. These marks change word meaning so they are important.",
            "Now that you know everything about Hawaii pronunciation lets have a little test. (Show them our list of words and have them go over them.) For the final exam let’s try to pronounce the name of the State fish—Humuhumunukunukuapua’a.",
            "",
            "CHAPEL:",
            "This small type of chapel was built throughout Hawaii during the 1850s and represents all denominations. The first to actively introduce Christianity to Hawaii were the Congregationalists from New England in 1820. Many of the Congregationalists made Hawaii their home and their descendents still live here.",
            "The second group to come to Hawaii were the Catholics. They originally came in 1827 but did not really get established until the 1840s. These missionaries were single priests. One such priest, Father Damien, went to the island of Molokai to help those patients with Hansen’s disease, commonly called leprosy, in Kalapapa. At that time people who had leprosy in Hawaii were taken there by boat and were dropped off shore and had to swim to shore. There weren’t facilities to take care of them and their quality of life was terrible. Father Damien helped to change that and hence became a hero to those people. For 16 years he lived with the lepers until he too died of leprosy, which he contracted while working there. In 2009, Father Damien was canonized, and was named Saint Damien by Pope Benedict XVI. Today leprosy or Hansen’s disease is controllable and no one is required to undergo the isolation from society that used to be the norm.",
            "The third group of missionaries to come to Hawaii was from the Church of Jesus Christ of Latter-day Saints also known as the Mormons. In February 1851, the first convert to the LDS Church was baptized in Hawaii. By August of that same year, there were five congregations with 220 members. A meetinghouse was built in Pulehu on the island of Maui in 1852. This structure still remains today. In 1854, Lanai became the designated gathering place for members, where a colony and plantation began.",
            "The Church purchased land at Laie to establish a colony, a sugar factory, and a school. The Church College of Hawaii (now BYU—Hawaii) opened in September 1955. In 1963, the Polynesian Cultural Center opened to represent the various South Pacific cultures. These structures, in addition to the temple completed in 1919, bring international attention to the Church.",
            "The organ is a pump organ that was built by the Estey Organ Company in Vermont in 1890. It was restored by LDS missionaries and is on display in working order here at the Polynesian Cultural Center.",
            "The Hawaiian wordings hanging behind the podium in the chapel are copies of panels that hung in the old Mormon chapel in La’ie, built in the late 1800’s. They say:",
            "“E HO’OMANA’O OIA IA NA MOKUPUNA O KE KAI”",
            "Translated into English, “He will remember the islands of the sea.” – Isaiah 11:11",
            "“O KA MEA HO'OMANAWANUI AKU A HIKI I KA HOPENA E OLA IA”",
            "Translated into English, “He who endures to the end, the same shall be saved.” – Matthew 10:22",
  ...
  },
  {
    ...
    emoji: '🌺',
    color: '#0ea5e9',
    image: require('../../assets/images/rn/rn.png'),
    sections: {
        overview: {
            image: [],
            paragraphs: [
            ...
            "Factoid: Rapa Nui, according to research and oral traditions, was once covered with trees, which have since all been cut down, possibly to aid in the construction and transportation of the almost 900 moai or stone monuments.",
            "",
            "RAPA NUI",
            "“IO RANA!” is the greeting word in Rapa Nui.",
            ...
            "",
            "THE PCC EXHIBIT:",
            "The Polynesian Cultural Center added this Rapa Nui exhibit as part of its 40th anniversary celebration in 2003. In preparing for the new exhibit, the Polynesian Cultural Center, with the consent of the government and cultural elders of Rapa Nui, invited four respected stone carvers to Laie, Hawaii, where they created seven authentic moai: two of them approximately 6 meters long are reclining (one of them intentionally left partially finished) and the other five about 3.5 meters high have been erected on an ahu or burial platform patterned after the famous one in Rapa Nui: Ahu Nau Nau at Anakena.",
            ...
            "",
            "MANA VAI: Protected Garden Pit",
            "This structure was created to protect the delicate plants from strong winds. Rapa Nui has an average elevation of 200 feet above sea level. The winds that are generated at sea have little to no resistance from the islands. Rapa Nui people found that they could protect the plants from the winds by creating rock walls around them. These walls would also help the plants gather water from the infrequent rains during the summer months. The Mana Vai housed Rapa Nui staple foods such as taro, banana, sugar cane, and sweet potato.",
            "This Mana Vai has been left half finished to allow those taking the canoe tour a better view of the interior structure.",
            "",
            "HARE MA’EA: Stone Structures",
